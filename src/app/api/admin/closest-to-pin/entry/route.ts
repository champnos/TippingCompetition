...
export async function POST(req: NextRequest) {
  ...
  if (error) {
    ...
    return NextResponse.redirect(new URL('/admin/closest-to-pin?error=entry_save_failed', req.url))
  }

  return NextResponse.redirect(new URL('/admin/closest-to-pin', req.url))
}
