...
export async function POST(req: NextRequest) {
  ...
  if (error) {
    console.error('Margin entry error:', error)
    return NextResponse.redirect(new URL('/admin/margin?error=entry_save_failed', req.url))
  }
  ...
  return NextResponse.redirect(new URL('/admin/margin', req.url))
}
